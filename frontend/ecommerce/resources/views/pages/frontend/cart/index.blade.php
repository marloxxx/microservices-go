                                    ...
                                    @foreach ($carts as $cart)
                                        <tr>
                                            ...
                                            <td class="tp-cart-img">
                                                <a href="{{ route('products.show', auth()->user()->id) }}">
                                                    <img src="{{ asset($cart->ProductImage) }}" alt="cart image">
                                                </a>
                                            ...
                                            <td class="tp-cart-title">
                                                <a
                                                    href="{{ route('products.show', auth()->user()->id) }}">{{ $cart->ProductName }}</a>
                                            </td>
                                            <!-- price -->
                                            <td class="tp-cart-price"><span>{{ $cart->Price }}</span></td>
                                            <!-- quantity -->
                                            <td class="tp-cart-quantity">
                                                <div class="tp-product-quantity mt-10 mb-10">
                                                    <span class="tp-cart-minus" onclick="decrement({{ $cart->ID }})">
                                                    ...
                                                    <input class="tp-cart-input" type="text" name="quantity"
                                                        id="quantity" value="{{ $cart->Quantity }}">
                                                    <span class="tp-cart-plus" onclick="increment({{ $cart->ID }})">
                                            ...
                                            <td class="tp-cart-action">
                                                <button class="tp-cart-action-btn" type="button"
